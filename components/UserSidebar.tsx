...
import { Home, CheckSquare, Bell, Settings, LogOut, User, ChevronRight, Building2 } from 'lucide-react';
  ...
  return (
    <aside className="hidden md:flex flex-col w-72 bg-[#0F172A] border-r border-slate-800 h-screen sticky top-0 transition-all z-20">
      ...
      <div className="p-6 pb-8">
        <div className="flex items-center gap-3 text-white mb-8 group cursor-pointer" onClick={() => navigate('/user')}>
      ...
      <div className="px-4 flex-1">
        ...
        <nav className="space-y-2">
          ...
          <NavLink to="/user/notifications" className={navClass}>
            <div className="relative">
          ...
          <NavLink to="/user/companies" className={navClass}>
            <Building2 size={20} className="stroke-[1.5]" />
            <span className="text-sm font-medium tracking-wide">My Companies</span>
          </NavLink>
        </nav>
      </div>
